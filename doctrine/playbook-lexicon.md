...
**The two ends ◆** — The load-bearing geometry of the book: **origination at the front, answerability at the back**, with the agent owning everything in between. The human holds both ends; they never transfer.
...
**The producible middle** — Everything between the two ends; the work the agent takes. *Reader-facing:* "the AI takes everything in between." *Related:* **gating the middle** — the human checkpoints every producible deliverable the agent makes.
...
**Produce / produce-and-explain ◆** — Two ways to write an agent Skill. *Produce:* hand over the deliverable. *Produce-and-explain:* narrate *why* it made each choice, the way a senior engineer narrates to a junior. Same Skill, tuned for the audience — transfer or substitution.
