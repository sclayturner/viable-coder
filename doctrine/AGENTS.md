...
- `reader-orientation-pattern.md`: the chapter- and module-level teaching rhythm for orienting readers through scene, tension, distinction, tool, and return.
- `voice/`: source material for Clay's style, posture, lived answerability, and philosophical commitments.

## Working Rules

- Change doctrine deliberately. A doctrine change may require follow-up edits in book, website, research, and skills.
- When adding a term, decide whether it belongs in `playbook-lexicon.md`.
- When changing a core distinction, check whether the four-section architecture still holds.
