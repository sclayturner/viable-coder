...
Use this file to route context loads. Prefer canonical files over `archive/`.
...
- Measurement and evidence: `research/evidence-ledgers/`
- Instruments: `research/instruments/`
- Data alignment: `website/docs/data-collection-alignment.md`

## Website

- Static site: `website/public/`
- Page manifest: `website/docs/page-manifest.md`
