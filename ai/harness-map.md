...
- 2026-06-30: **Private kit app and Unit/Lesson realignment.** Ratified the product shift from "manuscript plus reference application" to an integrated private kit app with curriculum inside it. Renamed `book/` to `curriculum/`, `curriculum/manuscript/` to `curriculum/lessons/`, and active legacy `section-*` curriculum artifacts to `unit-*`. Replaced the old user-facing structure labels with Units/Lessons while preserving modules as the audience-configuration layer.
...
- 2026-07-01: **Lesson bundle standard.** Defined the target app-renderable lesson structure under `curriculum/units/` and the component vocabulary: lesson prose, vocabulary, exercise, kit action, artifacts, and signals. Added `curriculum/templates/lesson-bundle/`, `curriculum/units/README.md`, and `curriculum/vocabulary/README.md`.
  - Canonical surfaces updated: `doctrine/playbook-lexicon.md`, `doctrine/reader-orientation-pattern.md`, `ai/viable-coder-kit-concept-manifest.md`, `curriculum/AGENTS.md`, and `ai/source-map.md`.
