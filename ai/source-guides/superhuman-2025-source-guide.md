# Superhuman 2025 Source Guide

This guide indexes Clay Turner's prior book, `Superhuman: Mastering AI Agents to Exceed Personal Limits`, for use inside the Viable Coder project.
...
This book predates the current Viable Coder frame. It was written before the project had:

- the Becoming Viable / Remaining Viable structure;
- the two-ends doctrine of origination and answerability;
- the ADLC as a governed agent development lifecycle;
- the module, persona, operating-profile, and skill-register architecture;
...
- Clay's personal-life experience beneath the founder and engineer frames;
- earlier philosophical material about human limitation, time, formation, imagination, reinvention, faith, fear, family, and purpose;
- the scarcity-to-capability pattern: financial pressure, market timing, and AI skill formation before business demand matured;
- the older Seeker / Maker / Orchestrator model as a precursor to current audience and module thinking;
- early agent and orchestration language as a historical precursor to the ADLC;
- voice calibration where current copy has become too abstract, sterile, or consultant-like.

Do not use it as:

- current AI market research without verification;
- canonical doctrine without promotion into `doctrine/`;
...
When using this source, classify each extract before promoting it:
...
The main conceptual reframe is:

- **Old frame**: become "superhuman" by mastering AI agents to exceed personal limits.
- **Current frame**: become and remain viable by using AI while preserving human origination, answerability, judgment, review capacity, and long-term condition.

Treat "superhuman" language as historical. The durable idea is not that AI makes the person superhuman. The durable idea is that AI can widen human capability only if it does not hollow out the human faculties that make the capability worth having.

Treat "Orchestrator" language as a precursor. In current doctrine, orchestration must be governed by gates, signals, skills, and the human holding the two ends.

Treat "personal limits" language as a precursor to current condition, observability, upkeep, operating profile, and nine-dimension viability work.

## Recommended Extraction Passes

1. **Personal-life anchors**: extract moments about time, family, reinvention, fear, ambition, faith, imagination, error, and adjustment.
2. **Scarcity-to-capability thread**: identify passages where financial pressure, market timing, and AI skill formation connect.
3. **Human-limits map**: compare the old ten-limit taxonomy against the current condition and nine-dimension models.
4. **Orchestrator-to-ADLC map**: identify old agent orchestration claims that can become governed ADLC guidance.
5. **Historical AI claims audit**: list claims that are useful but dated, then verify them before any research or website use.
6. **Voice calibration pass**: identify passages that carry Clay's lived tone without importing obsolete framing.
